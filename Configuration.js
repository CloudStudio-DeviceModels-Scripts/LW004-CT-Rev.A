...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // endpoints.addEndpoint("2", "CO2 sensor", endpointType.ppmConcentrationSensor, ppmConcentrationSensorSubType.carbonDioxide);
    endpoints.addEndpoint("1", "Alarm status", endpointType.alarmStatus);
    endpoints.addEndpoint("2", "MAC Address", endpointType.macAdd);
    endpoints.addEndpoint("3", "Timestamp", endpointType.timestamp);
