...
# Parsing + Configuration Script – LW004-CT - Rev. A

This **Parsing + Configuration** script is designed for the **LW004-CT** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – LW004-CT Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **LW004-CT** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
